...
public class JavaNetHttpHelper implements HttpHelper {
	...
	private static final String TAG = "HttpConnHelper";
	...
	private String getResponseFrom(HttpURLConnection c) throws IOException,
		...
		BufferedReader reader = new BufferedReader(new InputStreamReader(
				c.getInputStream(), DEFAULT_CHARSET));
	...
	/**
	 * A Url rewriter that does nothing, i.e., returns the url that is passed to
	 * it.
	 */
